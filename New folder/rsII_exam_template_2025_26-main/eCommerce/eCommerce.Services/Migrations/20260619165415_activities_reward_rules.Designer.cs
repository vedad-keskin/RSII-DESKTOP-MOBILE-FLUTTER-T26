...
namespace eCommerce.Services.Migrations
{
    ...
    [Migration("20260619165415_activities_reward_rules")]
    partial class activities_reward_rules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eCommerce.Services.Database.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Description = "",
                            DueDate = new DateTime(2026, 6, 24, 0, 0, 0, 0, DateTimeKind.Utc),
            ...
            modelBuilder.Entity("eCommerce.Services.Database.Gender", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eCommerce.Services.Database.UserActivity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ActivityId = 1,
                            CompletedAt = new DateTime(2026, 6, 21, 0, 0, 0, 0, DateTimeKind.Utc),
                            DateAssigned = new DateTime(2026, 6, 19, 0, 0, 0, 0, DateTimeKind.Utc),
                            Note = "Random note",
                            RewardTitle = "Organizacija sastanka - 10 points",
                            RewardedAt = new DateTime(2026, 6, 21, 0, 0, 0, 0, DateTimeKind.Utc),
                            Status = "Completed",
                            UserId = 1
                        },
                        new
            ...
            modelBuilder.Entity("eCommerce.Services.Database.RewardRule", b =>
                {
                    b.HasOne("eCommerce.Services.Database.Activity", "Activity")
                        .WithOne("RewardRule")
                        .HasForeignKey("eCommerce.Services.Database.RewardRule", "ActivityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
