...
namespace eCommerce.Services.Migrations
{
    ...
    [Migration("20260708030626_order_payment_card")]
    partial class order_payment_card
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eCommerce.Services.Database.Order", b =>
                {
                    ...
                    b.Property<int?>("PaymentCardIB180079Id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PaymentCardIB180079Id");
            ...
            modelBuilder.Entity("eCommerce.Services.Database.Order", b =>
                {
                    b.HasOne("eCommerce.Services.Database.PaymentCardIB180079", "PaymentCard")
                        .WithMany()
                        .HasForeignKey("PaymentCardIB180079Id");
