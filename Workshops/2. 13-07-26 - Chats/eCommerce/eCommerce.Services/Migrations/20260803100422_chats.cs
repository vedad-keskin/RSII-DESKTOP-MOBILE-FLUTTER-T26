    ...
    public partial class chats : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatsIB180079", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChatsIB180079_Users_User1Id",
                        column: x => x.User1Id,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatsIB180079_Users_User2Id",
                        column: x => x.User2Id,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatMessagesIB180079", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChatMessagesIB180079_ChatsIB180079_ChatId",
                        column: x => x.ChatId,
                        principalTable: "ChatsIB180079",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatMessagesIB180079_Users_SenderUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMessagesIB180079_ChatId",
                table: "ChatMessagesIB180079",
                column: "ChatId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatMessagesIB180079_SenderUserId",
                table: "ChatMessagesIB180079",
                column: "SenderUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatsIB180079_User1Id",
                table: "ChatsIB180079",
                column: "User1Id");

            migrationBuilder.CreateIndex(
                name: "IX_ChatsIB180079_User2Id",
                table: "ChatsIB180079",
                column: "User2Id");
